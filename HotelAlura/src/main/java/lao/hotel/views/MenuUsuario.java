...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/pessoas.png"));
		...
		labelRegistro.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/reservado.png"));
