...
import lao.hotel.db.InsertHospede;
import lao.hotel.db.InsertReserva;
...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede(Reservas r) {
		...
		//txtNreserva.setText(String.valueOf(r.getID_RES()));
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					try {
						...
						//novoHospedeInsert.fechaCon();

						JOptionPane.showMessageDialog(null, "REGISTRO INSERIDO COM SUCESSO", "REGISTRO INSERIDO",
		...
		imageFundo.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/registro.png"));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/Ha-100px.png"));
	}
