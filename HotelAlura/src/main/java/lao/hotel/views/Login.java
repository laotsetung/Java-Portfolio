...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/img-hotel-login-.png"));
		...
		logo.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/lOGO-50PX.png"));
	...
	private void Login() throws SQLException {
		...
		//String Usuario = loginD.selectUser(txtUsuario.getText());
	 	//String Senha="admin";
		//String Senha = loginD.selectUser(txtUsuario.getText());
		String[] usersDB = loginD.selectUser(txtUsuario.getText());

		String senha_digitada=new String (txtSenha.getPassword());

		if(txtUsuario.getText().equals(usersDB[0]) && senha_digitada.equals(usersDB[1])){
