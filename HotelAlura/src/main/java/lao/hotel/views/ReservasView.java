...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtDataE.getDate() != null && txtDataS.getDate() != null) {
					...
					if(verificaDataMenor(dataEntrada,hoje)){ //verifica se a primeira data do argumento é maior que a segunda!
					...
					if(prossegue){
						...
						System.out.println(dataEntrada.getDate());
		...
		imagenFondo.setIcon(new ImageIcon("src/main/java/lao/hotel/imagenes/reservas-img-3.png"));
